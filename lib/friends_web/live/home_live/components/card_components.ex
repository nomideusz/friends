defmodule FriendsWeb.HomeLive.Components.CardComponents do
  ...
  attr :show_pin, :boolean, default: false
  attr :is_pinned, :boolean, default: false
  attr :item_type, :string, default: "photo"
  ...
  def photo_card(assigns) do
    ...
    >
      ...
      <%= if @show_pin do %>
        <button
          type="button"
          phx-click={if @is_pinned, do: "unpin_item", else: "pin_item"}
          ...
          title={if @is_pinned, do: "Unpin", else: "Pin"}
        >
          <svg class={"w-4 h-4 #{if @is_pinned, do: "text-yellow-400", else: "text-white/60 hover:text-yellow-400"}"} fill={if @is_pinned, do: "currentColor", else: "none"} stroke="currentColor" viewBox="0 0 24 24">
  ...
  attr :show_pin, :boolean, default: false
  attr :is_pinned, :boolean, default: false
  attr :item_type, :string, default: "note"
