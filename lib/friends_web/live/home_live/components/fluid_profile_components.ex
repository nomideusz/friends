    ...
    <div class="flex flex-col h-full">
      ...
      <div class="flex-1 overflow-y-auto px-4 py-3 space-y-4">
        ...
        <%= if @current_user.username == "rietarius" do %>
          <%!-- Admin Section (only for rietarius) --%>
          <div>
            <h3 class="text-[10px] font-bold text-red-400/60 uppercase tracking-widest mb-2">Admin</h3>
            <div class="space-y-1">
              <%!-- Cleanup Test Users --%>
              <button
                phx-click="admin_cleanup_test_users"
                data-confirm="This will DELETE all test accounts except protected users. Are you sure?"
                class="w-full flex items-center justify-between p-3 rounded-xl bg-red-500/10 hover:bg-red-500/20 transition-all group"
              >
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-lg bg-red-500/20 flex items-center justify-center">
                    <svg class="w-4 h-4 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
